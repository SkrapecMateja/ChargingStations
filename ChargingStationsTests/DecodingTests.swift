...
class DecodingTests: XCTestCase {
    ...
    func testStationDecodingAndMappingToModel() async throws {
        ...
        let stations = apiStationsWrapper.stations.compactMap { Station(apiStation: $0) }
        ...
        XCTAssertEqual(stations[1].availability, .outOfService)
        ...
        XCTAssertEqual(stations[0].chargingFacilities[1].power, 22)
    }
}
